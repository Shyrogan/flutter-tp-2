...
class WeatherWidgetState extends State<WeatherWidget> {
  ...
  WeatherWidgetState() {
    weatherFactory = WeatherFactory("7cc5f9e3b9c29b6175494c9d2924e6c3",
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(
                ...
                onPressed: () async {
                  final r = await weatherFactory
                      .fiveDayForecastByCityName(cityController.value.text);
                  setState(() {
                    forecasts = r;
                  });
                },
                ...
                return Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Text(
                          day.date.toString().substring(0, 16),
                        ),
                        ...
                        Text(
                            '${day.temperature?.celsius?.toStringAsPrecision(3)}°C (ressenti ${day.tempFeelsLike?.celsius?.toStringAsPrecision(3)}°C)'),
                        Text(
                            'Vent: ${day.windSpeed?.toStringAsPrecision(3)} km/h'),
